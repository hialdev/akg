            ...
            <div class="col-12">
                <div class="mb-4">
                    <div class="news-page-carousel owl-carousel owl-theme">
                        @foreach ($news as $new)
                            <a data-aos="fade-up" class="d-block news-carousel-item" href="{{route('news.show', $new->slug)}}" style="max-width: 20em">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 mb-3">
                <a data-aos="fade-up" href="{{route('news.show', $new->slug)}}" class="news-item d-flex align-items-center text-decoration-none text-dark">
