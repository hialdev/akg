...
@section('seo')
    ...
    @include('partials.seo', [
        'title' => $seo->get('career')->title ?? setting('seo.seo_title'),
        'description' => $seo->get('career')->description ?? setting('seo.seo_des'),
        'image' => strlen($seo->get('career')->image) > 2 ? Voyager::image($seo->get('career')->image) : Voyager::image(setting('seo.seo_img')),
        'keywords' => $seo->get('career')->keywords ?? setting('seo.seo_key'),
    ])
@endsection
@section('content')
<section class="py-5">
