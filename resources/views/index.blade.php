...
@endsection
@section('content')
<section data-aos="zoom-out-down" data-aos-duration="{{setting('site.duration')}}">
    @php
...
<section class="py-5" data-aos="fade-up" data-aos-duration="{{setting('site.duration')}}" id="explore">
...
<section data-aos="zoom-out-up" data-aos-duration="{{setting('site.duration')}}" class="bg-light h-100">
...
<section class="py-5">
    <div class="container-fluid py-5">
        <div class="row align-items-center">
            <div class="col-lg-4 p-5" data-aos="fade-right" data-aos-duration="{{setting('site.duration')}}">
            ...
            <div class="col-lg-8">
                <div>
                    <div class="news-carousel owl-carousel owl-theme">
                        @foreach ($news as $new)
                            <a class="d-block news-carousel-item" data-aos="fade-left" data-aos-duration="{{setting('site.duration')}}" href="{{route('news.show', $new->slug)}}">
...
<section class="border-top py-5">
    <div class="container py-5"
         ...
         data-aos-duration="{{setting('site.duration')}}"
      >
