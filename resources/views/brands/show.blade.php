...
<section>
    <div data-aos="fade-up" data-aos-duration="{{setting('site.duration')}}" class="container py-5">
        <div class="row py-3">
...
<section data-aos="fade-up" data-aos-duration="{{setting('site.duration')}}" class="py-5">
