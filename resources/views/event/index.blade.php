...
<section class="py-5">
    <div class="container">
        <div class="row">
            <div data-aos="fade-up" data-aos-duration="{{setting('site.duration')}}" class="col-md-6 mb-4">
                ...
                <div class="d-flex ">
                    ...
                    @endphp
                    <a href="{{$file && count($file) > 0 ? Voyager::image($file[0]->download_link) : setting('site.cpo_link')}}" class="btn btn-light rounded-0 d-flex align-items-start justify-content-center gap-2">
                        <div>
                        ...
                        {{setting('site.cpo_text')}}
                    </a>
                </div>
            </div>

            @foreach ($events as $event)
            <div data-aos="fade-up" data-aos-duration="{{setting('site.duration')}}" class="col-12 border mb-4 p-0">
...
<section data-aos="zoom-in-up" data-aos-duration="{{setting('site.duration')}}" class="py-5 bg-light">
    <div class="container">
        <div class="row h-100">
            <div class="col-md-6">
