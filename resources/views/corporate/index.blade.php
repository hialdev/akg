...
<section class="py-5" id="about">
    <div class="container">
        <div class="row">
            <div data-aos="fade-up" data-aos-duration="{{setting('site.duration')}}" class="col-12 mb-5">
            ...
            <div data-aos="fade-up" data-aos-duration="{{setting('site.duration')}}" class="col-12 text-center mb-5">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="row">
                    ...
                    <div data-aos="fade-up" data-aos-duration="{{setting('site.duration')}}" class="col-md-4 mb-4">
...
<section class="py-5" id="contact">
    <div class="container">
        <div class="row">
            <div data-aos="fade-right" data-aos-duration="{{setting('site.duration')}}" class="col-md-6 pe-md-5">
                <h1 class="mb-3">{{setting('content.contact_title')}}</h1>
                <p>{{setting('content.contact_desc')}}</p>
            </div>
            <div data-aos="fade-left" data-aos-duration="{{setting('site.duration')}}" class="col-md-6">
